...
@section('content')
    <main>
        <section id="arch-header" class="col-12 container-fluid text-center">
            <div class="arch-header-container row justify-content-center">
                <div class="col-8">
        ...
        <section id="arch-content" class="row col-12">
            ...
            <section class="mb-5 col-12 row justify-content-center">
                <div class="col-9 text-center ">
                    <h1>Сопутствующая документация</h1>
                    <p>Безусловно, архитектурный проект Concept Interiors содержит всю необходимую информацию для дальнейшей стадии строительства. Архитектурный проект передается заказчику в трех экземплярах для работы с подрядчиками.</p>
                </div>
        ...
        <section id="arch-footer" class="text-center m-auto col-12 row justify-content-center">

            <div class="arch-footer-container col-12 row">
                <section class="col-12 m-auto">
                    <h1>ЭТАПЫ И ПРОЦЕССЫ</h1>
                </section>
                <section class="col-12 m-auto row justify-content-around align-items-baseline">
